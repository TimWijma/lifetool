    ...
    <div class="drag-handle">
      ...
      <div class="header-content">
        ...
        <div class="stats-indicator">
          ...
          <span class="stats-mini">{{ todoStore.remainingCount }}/{{ todoStore.filteredTodos.length }}</span>
        </div>
      </div>
    </div>
...
const focusAddTodo = (): void => {
  ...
  const todoInput = document.querySelector('.todo-container input[type="text"]') as HTMLInputElement
  if (todoInput) {
    todoInput.focus()
  }
}
