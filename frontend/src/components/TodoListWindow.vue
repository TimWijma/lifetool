                ...
                <v-tooltip text="Complete All" location="top">
                    <template v-slot:activator="{ props }">
                        <v-btn
                            ...
                            :disabled="todoStore.allCompleted"></v-btn>
                    </template>
                </v-tooltip>
                ...
                <v-tooltip text="Clear Completed" location="top">
                    <template v-slot:activator="{ props }">
                        <v-btn
                            ...
                            :disabled="todoStore.completedCount === 0"></v-btn>
                    </template>
                </v-tooltip>
            </div>
        </div>
            ...
            <h3 class="text-h6 mb-2">
                {{
                    todoStore.activeTag === "all"
                        ? "No todos yet"
                        : `No todos in "${todoStore.activeTag}"`
                }}
            </h3>
            <p class="text-body-2 text-grey">
                {{
                    todoStore.activeTag === "all"
                        ...
                        : "Add a todo with this tag or switch to another list."
                }}
            </p>
        </v-card>
    </div>
